...
pipeline (\texttt{sede\_\allowbreak fsigma8\_\allowbreak isw\_\allowbreak finitek.\allowbreak py}), 0.9236 from the
...
\texttt{phiphi\_\allowbreak joint\_\allowbreak refit.\allowbreak py}; earlier estimates and caveats in
\texttt{results/\allowbreak phiphi\_\allowbreak test\_\allowbreak result.\allowbreak md}).
...
\texttt{likes\_\allowbreak install.\allowbreak yaml} (full setup in \texttt{src/\allowbreak README.\allowbreak md}). The
...
were run with the exact \texttt{lcdm\_\allowbreak mc.\allowbreak yaml} / \texttt{sede\_\allowbreak mc.\allowbreak yaml}
...
(\texttt{phiphi\_\allowbreak As.\allowbreak py}, \texttt{phiphi\_\allowbreak fullrefit.\allowbreak py}) and all caveats
are in \texttt{src/\allowbreak results/\allowbreak phiphi\_\allowbreak test\_\allowbreak result.\allowbreak md}.
