...
checksums are in the [`sede-observational-tests`](https://github.com/spsingularity/sede-observational-tests) repository; the production chain files, the minima, and
